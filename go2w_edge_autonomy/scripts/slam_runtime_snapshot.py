...
def run_local_snapshot(*, timeout_s: int) -> str:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--local", action="store_true", help="Collect from this machine instead of SSH.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.local:
        output = run_local_snapshot(timeout_s=args.timeout_s)
        host = "localhost"
    else:
