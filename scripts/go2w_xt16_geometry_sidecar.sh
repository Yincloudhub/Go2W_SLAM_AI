...
export GO2W_XT16_GEOMETRY_FOOTPRINT_FRONT_M="${GO2W_XT16_GEOMETRY_FOOTPRINT_FRONT_M:-0.30}"
export GO2W_XT16_GEOMETRY_FOOTPRINT_REAR_M="${GO2W_XT16_GEOMETRY_FOOTPRINT_REAR_M:-0.30}"
export GO2W_XT16_GEOMETRY_FOOTPRINT_HALF_WIDTH_M="${GO2W_XT16_GEOMETRY_FOOTPRINT_HALF_WIDTH_M:-0.30}"
export GO2W_XT16_GEOMETRY_FOOTPRINT_FILTER_MARGIN_M="${GO2W_XT16_GEOMETRY_FOOTPRINT_FILTER_MARGIN_M:-0.05}"
export GO2W_XT16_GEOMETRY_FOOTPRINT_LATERAL_FILTER_MARGIN_M="${GO2W_XT16_GEOMETRY_FOOTPRINT_LATERAL_FILTER_MARGIN_M:-0.0}"
...
start_sidecar() {
  ...
  nohup nice -n "${NICE_LEVEL}" "${PYTHON_BIN}" "${REPO_ROOT}/scripts/xt16_lidar_geometry_summary.py" \
    ...
    --footprint-filter-margin-m "${GO2W_XT16_GEOMETRY_FOOTPRINT_FILTER_MARGIN_M}" \
    --footprint-lateral-filter-margin-m "${GO2W_XT16_GEOMETRY_FOOTPRINT_LATERAL_FILTER_MARGIN_M}" \
